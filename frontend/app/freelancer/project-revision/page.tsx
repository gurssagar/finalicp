...
export default function ProjectRevisionPage() {
  ...
  const handleSubmitRevision = () => {
    navigate.push('/project-completion');
  };
  return <div className="flex min-h-screen bg-white">
              ...
              <div className="border border-gray-200 rounded-lg p-6">
                ...
                <div className="flex items-start gap-4 mb-6">
                  <div className="w-10 h-10 rounded-full overflow-hidden flex-shrink-0">
                    <img src="https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?q=80&w=300&auto=format&fit=crop" alt="User" className="w-full h-full object-cover" />
                  </div>
                  <div>
                    <p className="font-medium">
                      Here is your File you can finalise.
                    </p>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm">Variation1.pdf</span>
                    </div>
      ...
      {isModalOpen && <RevisionModal onClose={closeModal} onSubmit={handleSubmitRevision} />}
    </div>;
}