  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setRedirectCount(prev => {
        if (prev <= 1) {
          clearInterval(timer);
          // In a real app, navigate to dashboard or profile page
          // For now, we'll just redirect back to signup
  ...
  return <div className="max-w-xl w-full mx-auto px-6 py-12 bg-white rounded-3xl shadow-lg border border-gray-100 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center">
        ...
        <p className="text-gray-700 mb-8 max-w-md">
          ...
          process and are now officially a part of the ICPWork community –
