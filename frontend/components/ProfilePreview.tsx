...
import { SkillTag } from './SkillTag1';
...
export function ProfilePreview({
  ...
  return <div className="bg-white rounded-3xl shadow-lg border border-gray-100 p-8 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            {skills.map((skill, index) => <SkillTag key={index} skill={skill} removable={false} className="bg-white" />)}
          </div>
        </div>
        {/* Location */}
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            {hasResume ? <span className="text-gray-700">Resume.pdf</span> : <span className="text-gray-400">No resume uploaded</span>}
          </div>
        </div>
      </div>
    </div>;
